# frontends/window_basic/renderers.py
...
class WindowBasicRenderer(Renderer):
    def __init__(self, window: WindowBasic) -> None:
        self.window = window
    ...
    def render(self, game_state: GameState) -> None:
        ...
        if game_state.tie:
            ...
            return
        elif not game_state.winner: return
